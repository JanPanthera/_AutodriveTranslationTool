...
class OptionsFrame(ctk.CTkFrame):
    ...
    def __init__(self, app_instance, tab_view):
        ...
        self.GUI_FILE_PATH = os.path.join(self.app_instance.dev_path, "src", "components", "options_frame.gui.json")
    ...
    def _on_ui_color_theme(self, selected_color_theme=None):
        ...
        ui_color_theme = color_theme_key if color_theme_key in ["blue", "dark-blue", "green"] else os.path.join(self.app_instance.dev_path, "resources", "themes", f"{color_theme_key}.json")
